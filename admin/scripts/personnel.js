...
function loadpage() {
	...
	var oTable = $('#personnel-table').dataTable(settings);
	oTable.fnDestroy();
 
	$('#personnel-table tbody').html('');

	$.post('classes/personnel.class.php', {loadpage:1}, function(data) {
        var pageContent = data;
		$('#personnel-table tbody').html(pageContent);
        var oTable = $('#personnel-table').dataTable(settings);
	})
}
...
function loadForm() {
	...
	$.post('classes/personnel.class.php', {loadRecord:1, id:0}, function(data) {
...
function loadRecord(id) {
	...
	$('#submit-add').hide();
	$('#submit-edit').show();
	$.post('classes/personnel.class.php', {loadRecord:1, id:id}, function(data) {
        var record = JSON.parse(data);
...
function loadProfile(id) {
	$.post('classes/personnel.class.php', {loadProfile:1, id:id}, function(data) {
        var record = JSON.parse(data);
...
function updateRecord() {
    ...
    var form = $('#personnel-form')[0];
    var data = new FormData(form);

    $.ajax({
        type: "POST",
        enctype: 'multipart/form-data',
        url: "classes/personnel.class.php",
        data: data,
        processData: false,
        contentType: false,
        cache: false,
...
function deleteRecord(id) {
    ...
    if (result) {
    	$.post('classes/personnel.class.php', {deleteRecord:1, id:id}, function(data) {
    	   loadpage();
    	})
    }
}
...
function setStatus(id, status) {
	$.post('classes/personnel.class.php', {setStatus:1, id:id, status: status}, function(data) {
