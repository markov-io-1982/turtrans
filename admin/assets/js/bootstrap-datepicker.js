 ...
 * Repo: https://github.com/eternicode/bootstrap-datepicker2/
 * Demo: http://eternicode.github.io/bootstrap-datepicker2/
 * Docs: http://bootstrap-datepicker2.readthedocs.org/
 * Forked from http://www.eyecon.ro/bootstrap-datepicker2
 * =========================================================
...
(function($, undefined){
	...
	datepicker2.prototype = {
		...
		_buildEvents: function(){
			...
			else if (this.element.is('div')){  // inline datepicker2
				this.isInline = true;
			}
			else {
				this._events = [
		...
		fillDow: function(){
			...
			if (this.o.calendarWeeks){
				...
				html += cell;
				this.picker.find('.datepicker2-days thead tr:first-child').prepend(cell);
			}
		...
		fill: function(){
			var d = new Date(this.viewDate),
				...
				tooltip;
			this.picker.find('.datepicker2-days thead th.datepicker2-switch')
		...
		showMode: function(dir){
			...
			this.picker
				.find('>div')
				.hide()
				.filter('.datepicker2-'+DPGlobal.modes[this.viewMode].clsName)
					.css('display', 'block');
			this.updateNavArrows();
		}
	};
	...
	DateRangePicker.prototype = {
		...
		dateUpdated: function(e){
			...
			var dp = $(e.target).data('datepicker2'),
		...
		this.each(function(){
			...
			if (!data){
				...
				if ($this.is('.input-daterange') || opts.inputs){
					...
					$this.data('datepicker2', (data = new DateRangePicker(this, $.extend(opts, ropts))));
				}
				else {
					$this.data('datepicker2', (data = new datepicker2(this, opts)));
				}
			}
				...
				for (i=0; i < parts.length; i++){
					...
					switch (part[2]){
						case 'd':
							...
							break;
						case 'm':
							date = datepicker2.prototype.moveMonth.call(datepicker2.prototype, date, dir);
							break;
						case 'w':
							date.setUTCDate(date.getUTCDate() + dir * 7);
							break;
						case 'y':
							date = datepicker2.prototype.moveYear.call(datepicker2.prototype, date, dir);
							break;
					}
				}
	...
	* ================== */
	...
	$(function(){
		$('[data-provide="datepicker2-inline"]').datepicker2();
	});
