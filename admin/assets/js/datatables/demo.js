+function ($) {
  ...
  $(function () {
    ...
    // location_list
    $('[data-ride="location_list"]').each(function () {
      var oTable = $(this).dataTable({
        "bProcessing": true,
        "sAjaxSource": "js/datatables/location_list.json",
        "sDom": "<'row'<'col-sm-4'l><'col-sm-4'f ><'col-sm-4'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>",
        "sPaginationType": "full_numbers",
        "aoColumns": [
          { "mData": "ID" },
          { "mData": "city" },
