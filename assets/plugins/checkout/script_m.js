  ...
  render() {
    return (
     ...
     // React.createElement(Button, { bsStyle: "primary", type: "submit" }, "Оплатити"),
      ...
      React.createElement("input", { className: "parsley-validated", type: "checkbox", id: "checkBookingDebit", name: "checkBookingDebit",
      value: "option1", "data-required": "true", "data-error-message": "Ви повинні погодитися з політикою сайту." }),

      React.createElement("label", { htmlFor: "checkBookingDebit"}, "Я приймаю",
